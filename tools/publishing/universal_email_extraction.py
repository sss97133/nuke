...
MBOX_SOURCES = [
    ("operator_a_email_archive/inbox.mbox", "jenny_tpo", "inbox"),
    ("operator_a_email_archive/sent_messages.mbox", "jenny_tpo", "sent"),
    ("operator_a_email_archive/archive.mbox", "jenny_tpo", "archive"),
    ("operator_a_email_archive/drafts.mbox", "jenny_tpo", "draft"),
