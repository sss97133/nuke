...
MBOX_FILES = [
    f"{HOME}/operator_a_email_archive/inbox.mbox",
    f"{HOME}/operator_a_email_archive/sent_messages.mbox",
    f"{HOME}/operator_a_email_archive/archive.mbox",
    f"{HOME}/operator_a_email_archive/drafts.mbox",
