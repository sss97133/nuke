          ...
          <div className="bg-white border border-gray-200 rounded-xl p-4">
            ...
            {Object.keys(conflicts).length > 0 && (
              <div className="mt-3 pt-3 border-t border-gray-100">
                <p className="text-xs text-amber-600 font-medium">Conflicts detected in: {Object.keys(conflicts).join(', ')}</p>
              </div>
            )}
          </div>
        </div>
            ...
            {pages.map(page => (
              ...
              >
                <div className="h-32 bg-gray-100 flex items-center justify-center overflow-hidden">
                  {imageUrls[page.id] ? (
                    <img src={imageUrls[page.id]} className="w-full h-full object-contain object-center" alt="" loading="lazy" />
                  ) : (
