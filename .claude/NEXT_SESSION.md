...
CEO (Skylar) cannot demo the platform to client the buyer. Profiles are broken, vehicles don't show, and there's no way to diagnose user issues. **All agents: read your assigned issues below and execute immediately.**
