...
grep -E "(REDACTED-ROTATED|whsec_dCdCvyVecYrwSUocJqxKdq0teAiElJYQ)" .env 2>/dev/null && echo "UNROTATED KEYS FOUND"
...
|-----|---------|----------|-----------|
| Gemini API Key | `REDACTED-ROTATED` | PENDING | https://aistudio.google.com/app/apikey |
