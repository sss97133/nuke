...
exports.fixImageOrientation = fixImageOrientation;
...
async function fixImageOrientation() {
    ...
    try {
        ...
        const { data: images, error } = await supabase_1.supabase
            .from('vehicle_images')
        ...
        for (const image of images) {
            try {
                ...
                const result = await imageOptimizationService_1.imageOptimizationService.generateVariantBlobs(await fetchAsFile(image.image_url, image.filename));
