      ...
      {modes.map((m) => (
        <button
          ...
          style={{
            ...
            padding: '6px 12px',
            border: '2px solid',
            borderColor: active === m.id ? '#000' : 'var(--border, #bdbdbd)',
            background: active === m.id ? '#000' : 'var(--surface, #fff)',
            color: active === m.id ? '#fff' : 'var(--text, #000)',
            cursor: 'pointer',
            marginRight: -2,
            position: 'relative',
    ...
    <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
      ...
      <button
        ...
        style={{
          ...
          fontFamily: 'Arial, sans-serif',
          border: '2px solid',
          borderColor: imagesOnly ? '#000' : 'var(--border, #bdbdbd)',
          background: imagesOnly ? '#000' : 'var(--surface, #fff)',
          color: imagesOnly ? '#fff' : 'var(--text, #000)',
          cursor: 'pointer',
        }}
      >
