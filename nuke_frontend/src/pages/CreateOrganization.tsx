      ...
      <div style={{ maxWidth: '600px', margin: '0 auto' }}>
        <div className="card">
          <div className="card-header">
            <h1 style={{ margin: 0, fontSize: '19px', fontWeight: 700 }}>Create Organization Profile</h1>
          ...
          <div className="card-body">
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ marginBottom: '16px' }}>
                <h3 style={{ fontSize: '15px', fontWeight: 700, marginBottom: '12px', borderBottom: '1px solid var(--border-light)', paddingBottom: '4px' }}>
                  Basic Information
                </h3>
