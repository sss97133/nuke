    ...
    switch (type) {
      ...
      case 'total_views': {
        const viewsByPlatform = Object.entries(stats.by_platform).map(([platform, data]) => ({
          platform,
          label: platform === 'nzero' ? 'Nuke' : platform.replace(/_/g, ' ').replace(/\b\w/g, l => l.toUpperCase()),
          value: listings
    ...
    <div className="card">
      ...
      <div className="card-body">
        ...
        <div style={{ marginTop: 'var(--space-3)', fontSize: 'var(--font-size-small)', color: 'var(--text-muted)' }}>
          Platform: {listing.platform === 'nzero' ? 'Nuke' : listing.platform.replace(/_/g, ' ')}
    ...
    <div style={{ padding: 'var(--space-4)' }}>
      ...
      >
        ...
        >
          ...
          <option value="nzero">Nuke</option>
