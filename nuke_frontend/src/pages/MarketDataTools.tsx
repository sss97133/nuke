...
export default function MarketDataTools() {
  ...
  return (
    <div style={{ padding: 'var(--space-4)' }}>
      <h1 style={{ fontSize: '16px', fontWeight: 'bold', margin: 0, marginBottom: 'var(--space-4)' }}>
        Market Data Tools
      </h1>
      <p style={{ fontSize: '11px', color: 'var(--text-muted)', marginBottom: 'var(--space-4)' }}>
                    ...
                    {backfillResult.results && (
                      <div style={{ marginTop: 'var(--space-2)' }}>
                        <details>
                          ...
                          <pre style={{ marginTop: 'var(--space-2)', fontSize: '9px', overflow: 'auto' }}>
