      ...
      {options.map((opt, i) => (
        <button
          ...
          style={{
            ...
            cursor: 'pointer',
            border: 'none',
            borderLeft: i > 0 ? '1px solid var(--border, #bdbdbd)' : 'none', backgroundColor: value === opt ? 'var(--text, #2a2a2a)' : 'transparent',
  ...
  return (
    <Link
      ...
      style={{
        ...
        letterSpacing: '0.04em',
        padding: '3px 8px',
        border: '2px solid var(--text, #2a2a2a)', backgroundColor: hovered ? 'var(--text, #2a2a2a)' : 'transparent',
