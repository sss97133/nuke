...
import { QuotePartsList } from '../parts/QuotePartsList';
        ...
        >
          ...
          <div style={{
            ...
            <button
              ...
              disabled={!prevEvent}
              style={{
                background: prevEvent ? 'var(--text)' : 'var(--border)',
                color: 'var(--bg)',
                border: 'none',
                padding: '8px 16px',
            ...
            >
              ...
              {prevEvent && prevDateStr && (
                <span style={{ display: 'block', fontSize: '9px', marginTop: '2px', opacity: 0.8 }}>
                  {prevDateStr}
                </span>
              )}
            </button>
            ...
            <button
              ...
              disabled={!nextEvent}
              style={{
                background: nextEvent ? 'var(--text)' : 'var(--border)',
                color: 'var(--bg)',
                border: 'none',
                padding: '8px 16px',
          ...
          <div style={{ padding: '20px', overflow: 'auto', flex: 1 }}>
            ...
            {(bidAmount || bidder) && (
              <div style={{
                ...
                {bidAmount && (
                  <div style={{ fontSize: '24px', fontWeight: 700, color: 'var(--text)', marginBottom: '4px' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '12px' }}>
            <div style={{ flex: 1 }}>
              ...
              {vehicleId ? (
                <a
                  href={`/vehicle/${vehicleId}`}
                  style={{ fontSize: '17px', fontWeight: 700, color: 'var(--text)', textDecoration: 'none' }}
                  className="hover:underline"
                >
                  {vehicleName}
                </a>
              ...
              <div style={{ fontSize: '15px', color: 'var(--text-secondary)', marginTop: '2px' }}>
                {event.title}
              </div>
            </div>
        ...
        <div style={{
            ...
            <div>
              ...
              {workPerformed.length > 0 && (
                <div style={{ marginBottom: '20px' }}>
                  ...
                  <ul style={{ margin: 0, paddingLeft: '24px', fontSize: '12px', color: 'var(--text-secondary)' }}>
          ...
          {activeTab === 'labor' && (
            <div>
              {laborItems.length > 0 ? (
                <div>
                  <div style={{ fontSize: '13px', fontWeight: 700, marginBottom: '16px', color: 'var(--text)' }}>
                    Labor Breakdown
