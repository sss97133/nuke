        ...
        <div style={{
          ...
          {editMode && selectedVehicles.size > 0 && (
            <div style={{
              ...
              border: '1px solid var(--accent)', fontSize: '11px',
              fontWeight: 700,
              color: 'var(--accent)',
              display: 'flex',
              alignItems: 'center',
                    ...
                    <div className="card-body">
                      ...
                      {(v.vehicles.vin_is_valid === false || !v.vehicles.vin) && (
                        <div style={{
                          ...
                          border: `2px solid ${v.vehicles.vin_is_valid === false ? 'var(--error)' : 'var(--warning)'}`, fontSize: '11px',
                          fontWeight: 600,
                      ...
                      {isOwner && displayCategory === 'sold' && profit !== null && (
                        <div style={{
                          marginTop: '8px',
                          padding: '6px',
                          background: profit > 0 ? 'var(--success-dim)' : 'var(--error-dim)', fontSize: '11px',
                          fontWeight: 600,
