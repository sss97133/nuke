      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-1">
            {[115, 114, 113, 112, 111].map(price => <div key={price} className="grid grid-cols-3 text-xs font-mono text-red-500">
                <div>{price}.00</div>
          ...
          {/* Buy orders */}
          <div className="space-y-1">
            {[110, 109, 108, 107, 106].map(price => <div key={price} className="grid grid-cols-3 text-xs font-mono text-green-500">
                <div>{price}.00</div>
                <div className="text-right">1,000</div>
                <div className="text-right">{price * 1000}</div>
              </div>)}
