#!/usr/bin/env node
/**
 * Apply pending status migration using direct psql connection
 */
...
if (!DB_PASSWORD && !DB_URL) {
  ...
  console.error('\n💡 Alternative: Copy APPLY_PENDING_STATUS_MIGRATION.sql and paste into:');
...
async function applyMigration() {
  ...
  try {
    ...
    const tempFile = '/tmp/pending_migration.sql';
    ...
    console.log('\n📋 Next: Fix existing vehicles by running:');
