#!/usr/bin/env node
/**
 * Auto-generated extractor for https://velocityrestorations.com
 * Generated: 2026-01-25T18:08:11.089Z
 *
 * Usage: node extract-velocityrestorations-com.js [batch_size] [workers]
 */
...
const CONFIG = {
  ...
  "CURRENT_INVENTORY_URL": "https://www.velocityrestorations.com/for-sale/",
  "SOLD_INVENTORY_URL": "https://www.velocityrestorations.com/restorations/",
...
async function saveVehicle(data) {
  ...
  const vehicleData = {
    ...
    discovery_source: 'velocityrestorations-com',
    year: data.year,
...
async function main() {
  console.log('╔════════════════════════════════════════════════════════════╗');
  console.log('║  VELOCITYRESTORATIONS-COM EXTRACTOR');
  ...
  try {
    ...
    const listings = await discoverListings(page, 'https://velocityrestorations.com');
