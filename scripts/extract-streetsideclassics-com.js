#!/usr/bin/env node
/**
 * Auto-generated extractor for https://streetsideclassics.com
 * Generated: 2026-01-25T17:58:37.741Z
 *
 * Usage: node extract-streetsideclassics-com.js [batch_size] [workers]
 */
...
const CONFIG = {
  "SITE_TYPE": "dealer",
  "INVENTORY_URL_PATTERN": "https://www.streetsideclassics.com/vehicles/new_arrivals",
  "LISTING_URL_PATTERN": "https://www.streetsideclassics.com/vehicles/new_arrivals",
...
async function saveVehicle(data) {
  ...
  const vehicleData = {
    ...
    discovery_source: 'streetsideclassics-com',
    year: data.year,
...
async function main() {
  console.log('╔════════════════════════════════════════════════════════════╗');
  console.log('║  STREETSIDECLASSICS-COM EXTRACTOR');
  ...
  try {
    ...
    const listings = await discoverListings(page, 'https://streetsideclassics.com');
