#!/usr/bin/env node
/**
 * Auto-generated extractor for https://vanguardmotorsales.com
 * Generated: 2026-01-25T17:58:51.058Z
 *
 * Usage: node extract-vanguardmotorsales-com.js [batch_size] [workers]
 */
...
const CONFIG = {
  "SITE_TYPE": "dealer",
  "INVENTORY_URL_PATTERN": "https://www.vanguardmotorsales.com/inventory",
  "LISTING_URL_PATTERN": "https://www.vanguardmotorsales.com/sell-us-your-car",
  "EXTRACTION_SELECTORS": {
    ...
    "vin": ".vin, [class*=\"vin\"]",
    "mileage": "(\\d{1,3},?\\d{3})\\s*(miles?|mi)",
    "images": "img[src*=\"vehicle\"], .gallery img, .slider img"
  },
  "PAGINATION_PATTERN": "a[href*=\"page\"], .pagination a, [class*=\"next\"]",
  "CHALLENGES": [
    "lazy_loading",
    "dynamic_content"
  ],
...
async function saveVehicle(data) {
  ...
  const vehicleData = {
    ...
    discovery_source: 'vanguardmotorsales-com',
    year: data.year,
...
async function main() {
  console.log('╔════════════════════════════════════════════════════════════╗');
  console.log('║  VANGUARDMOTORSALES-COM EXTRACTOR');
  ...
  try {
    ...
    const listings = await discoverListings(page, 'https://vanguardmotorsales.com');
