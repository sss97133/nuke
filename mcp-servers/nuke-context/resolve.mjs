#!/usr/bin/env node
/**
 * resolve.mjs — "Update me on the Smith build"
 *
 ...
 * - Last communication
 *
 * Usage: node resolve.mjs "the Smith build"
...
if (!query) { console.error('Usage: node resolve.mjs "the Smith build"'); process.exit(1); }
