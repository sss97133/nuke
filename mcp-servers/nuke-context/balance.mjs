 ...
 *
 * Usage:
 *   dotenvx run -- node mcp-servers/nuke-context/balance.mjs "smith"
...
if (!SUPABASE_URL || !SUPABASE_KEY) {
  console.error('Missing env. Run with: dotenvx run -- node mcp-servers/nuke-context/balance.mjs "smith"');
  process.exit(1);
}
...
async function resolveWorkOrders() {
  ...
  console.error('Usage: balance.mjs "smith" | --wo <id> | --vehicle <id>');
  process.exit(1);
}
