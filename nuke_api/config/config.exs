...
config :nuke_api, NukeApiWeb.Endpoint,
  ...
  render_errors: [
    formats: [json: NukeApiWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: NukeApi.PubSub,
  live_view: [signing_salt: "2cJ2rTQ1"]
...
config :nuke_api, NukeApi.Mailer, adapter: Swoosh.Adapters.Local
