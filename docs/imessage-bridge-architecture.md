...
dotenvx run -- node scripts/imessage-bridge.mjs --chat "+15555550123"

# Daemon mode (continuous 2s poll)
dotenvx run -- node scripts/imessage-bridge.mjs --daemon --chat "+15555550123"

# Dry run (log what would happen, don't reply)
dotenvx run -- node scripts/imessage-bridge.mjs --dry-run --chat "+15555550123"
```
...
```bash
dotenvx run -- node scripts/imessage-bridge.mjs --reset --chat "+15555550123"
```
