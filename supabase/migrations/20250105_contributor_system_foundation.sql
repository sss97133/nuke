...
INSERT INTO department_presets (business_type, department_type, department_name, description, typical_roles) VALUES
-- Dealer presets
('dealer', 'sales', 'Sales Department', 'Vehicle sales and customer relations', ARRAY['sales_manager', 'salesperson', 'finance_manager']),
('dealer', 'consignment', 'Consignment Department', 'Consignment vehicle management', ARRAY['consignment_manager', 'salesperson']),
('dealer', 'showroom', 'Showroom', 'Vehicle display and presentation', ARRAY['showroom_manager', 'porter']),
('dealer', 'service', 'Service Department', 'Vehicle service and repairs', ARRAY['service_manager', 'technician', 'service_advisor']),
('dealer', 'parts', 'Parts Department', 'Parts sales and inventory', ARRAY['parts_manager', 'parts_specialist']),
('dealer', 'admin', 'Finance & Admin', 'Business administration', ARRAY['finance_manager', 'admin']),

-- Garage/Shop presets
('garage', 'service', 'Service Bay', 'General vehicle service', ARRAY['shop_manager', 'mechanic', 'apprentice']),
('garage', 'body_shop', 'Body Shop', 'Body work and collision repair', ARRAY['body_shop_manager', 'body_technician', 'painter']),
('garage', 'detailing', 'Detailing', 'Vehicle detailing and cleaning', ARRAY['detail_manager', 'detailer']),
('garage', 'parts', 'Parts Counter', 'Parts sales and inventory', ARRAY['parts_manager', 'counter_staff']),

-- Builder presets
('builder', 'custom_build', 'Custom Build Shop', 'Custom vehicle building', ARRAY['master_builder', 'fabricator', 'welder']),
('builder', 'paint_body', 'Paint & Body', 'Paint and body work', ARRAY['paint_manager', 'painter', 'body_man']),

-- Transporter presets
('transporter', 'transport', 'Transport Operations', 'Vehicle transport and logistics', ARRAY['dispatcher', 'driver', 'coordinator'])
