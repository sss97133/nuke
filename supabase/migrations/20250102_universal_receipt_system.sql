...
-- User's tool inventory (consolidated view) - drop if exists first
...
CREATE INDEX idx_line_items_part ON line_items(part_number);
...
CREATE INDEX idx_user_tools_part ON user_tools(part_number);
