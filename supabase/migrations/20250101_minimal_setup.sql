...
CREATE TABLE IF NOT EXISTS vehicles (
    ...
    year INTEGER,
    vin TEXT UNIQUE,
    -- Provenance + sourcing metadata expected by later migrations
    year_source TEXT,
    year_confidence INTEGER,
    make_source TEXT,
    ...
    transmission_confidence INTEGER,
    engine TEXT,
    engine_size TEXT,
    engine_source TEXT,
    engine_confidence INTEGER,
    horsepower INTEGER,
    torque INTEGER,
    drivetrain TEXT,
    body_style TEXT,
