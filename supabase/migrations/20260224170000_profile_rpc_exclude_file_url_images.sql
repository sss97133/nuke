-- Exclude file:// image_url from profile RPC (local paths don't load on web; caused 1800 broken images).
  ...
  SELECT json_build_object(
    ...
    'images', (
      ...
      WHERE vi.vehicle_id = p_vehicle_id
        ...
        AND (vi.image_url NOT LIKE 'file://%')
    ),
    'timeline_events', (
...
COMMENT ON FUNCTION public.get_vehicle_profile_data(uuid) IS 'Vehicle profile payload; excludes e2e_test and file:// images so test data and local paths never appear as primary or in gallery.';
