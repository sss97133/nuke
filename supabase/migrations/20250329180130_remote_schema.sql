    ...
    SET metadata = jsonb_set(
        ...
        (
            SELECT jsonb_build_object(
                ...
                'price_trend', CASE 
                    WHEN AVG(sale_price) > LAG(AVG(sale_price)) OVER (ORDER BY sale_date)
                    THEN 'increasing'
                    ELSE 'decreasing'
                END,
                'total_sales', COUNT(*),
...
CREATE OR REPLACE FUNCTION "public"."column_exists"("schema_name" "text", "table_name" "text", "column_name" "text") RETURNS boolean
    LANGUAGE "plpgsql"
    AS $$
DECLARE
...
ALTER FUNCTION "public"."column_exists"("schema_name" "text", "table_name" "text", "column_name" "text") OWNER TO "postgres";
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."auction_comments";
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."marketplace_comments";
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."stream_comments";



ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."stream_tips";
...
GRANT ALL ON FUNCTION "public"."column_exists"("schema_name" "text", "table_name" "text", "column_name" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."column_exists"("schema_name" "text", "table_name" "text", "column_name" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."column_exists"("schema_name" "text", "table_name" "text", "column_name" "text") TO "service_role";
