...
CREATE INDEX idx_interaction_requests_vehicle_id ON vehicle_interaction_requests(vehicle_id);
CREATE INDEX idx_interaction_requests_requester_id ON vehicle_interaction_requests(requester_id);
CREATE INDEX idx_interaction_requests_status ON vehicle_interaction_requests(status) WHERE status IN ('pending', 'approved', 'scheduled');

CREATE INDEX idx_interaction_sessions_vehicle_id ON vehicle_interaction_sessions(vehicle_id);
CREATE INDEX idx_interaction_sessions_host_id ON vehicle_interaction_sessions(host_id);
CREATE INDEX idx_interaction_sessions_participant_id ON vehicle_interaction_sessions(participant_id);
CREATE INDEX idx_interaction_sessions_start_time ON vehicle_interaction_sessions(start_time);

CREATE INDEX idx_viewer_activity_user_id ON viewer_activity(user_id);
CREATE INDEX idx_viewer_activity_vehicle_id ON viewer_activity(vehicle_id);
CREATE INDEX idx_viewer_activity_created_at ON viewer_activity(created_at DESC);

CREATE INDEX idx_vehicle_reviews_vehicle_id ON vehicle_reviews(vehicle_id);
CREATE INDEX idx_vehicle_reviews_reviewer_id ON vehicle_reviews(reviewer_id);
CREATE INDEX idx_vehicle_reviews_rating ON vehicle_reviews(overall_rating);

CREATE INDEX idx_interaction_notifications_recipient_id ON interaction_notifications(recipient_id);
CREATE INDEX idx_interaction_notifications_unread ON interaction_notifications(recipient_id) WHERE read_at IS NULL;
