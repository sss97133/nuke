...
DROP POLICY IF EXISTS "vehicle_production_data_read" ON vehicle_production_data;
...
DROP POLICY IF EXISTS "vehicle_production_data_write" ON vehicle_production_data;
