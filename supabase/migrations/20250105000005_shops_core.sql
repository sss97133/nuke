...
-- Shops policies
DROP POLICY IF EXISTS shop_select_for_members ON shops;
...
DROP POLICY IF EXISTS shop_members_select_for_members ON shop_members;
...
DROP POLICY IF EXISTS shop_members_insert_by_owner_admin ON shop_members;
...
DROP POLICY IF EXISTS shop_members_update_by_owner_admin ON shop_members;
...
DROP POLICY IF EXISTS shop_invites_select_for_owner_admin ON shop_invitations;
...
DROP POLICY IF EXISTS shop_invites_insert_owner_admin ON shop_invitations;
