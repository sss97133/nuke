...
DROP POLICY IF EXISTS "Vehicle owners can view shipping tasks" ON shipping_tasks;
...
DROP POLICY IF EXISTS "Contributors can view shipping tasks" ON shipping_tasks;
...
DROP POLICY IF EXISTS "Vehicle owners can manage shipping tasks" ON shipping_tasks;
...
DROP TRIGGER IF EXISTS trigger_update_shipping_task_updated_at ON shipping_tasks;

DROP FUNCTION IF EXISTS update_shipping_task_updated_at();
...
DROP TRIGGER IF EXISTS trigger_create_shipping_timeline_event ON shipping_tasks;

DROP FUNCTION IF EXISTS create_shipping_timeline_event();
