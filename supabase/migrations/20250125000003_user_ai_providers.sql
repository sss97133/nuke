...
-- Allows users to configure their own AI providers and API keys
...
CREATE TABLE IF NOT EXISTS user_ai_providers (
  ...
  cost_per_request_cents INTEGER DEFAULT 0, -- Cost in cents per request
...
-- Policy: Users can only view/manage their own AI providers
