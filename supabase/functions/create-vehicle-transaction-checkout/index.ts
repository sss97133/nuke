...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      mode: 'payment',
      success_url: `${Deno.env.get('FRONTEND_URL') || 'https://n-zero.dev'}/transaction/${transaction.id}/success`,
      cancel_url: `${Deno.env.get('FRONTEND_URL') || 'https://n-zero.dev'}/vehicle/${vehicle_id}`,
