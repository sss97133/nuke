...
function isKnownNoiseUrl(url: string): boolean {
  ...
  // Barrett-Jackson auction venue maps (palm_beach.jpg, scottsdale.jpg, lv21_location_map.jpg, etc.)
  if (s.includes('/auctionsite') || s.includes('location_map')) return true;
